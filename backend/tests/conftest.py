...
def temp_db(tmp_path, monkeypatch):
    ...
    config.DB_PATH is redirected to the same temp file so that any module
    opening its own connection (db.get_connection / timeseries) can never
    touch the production event bus.
    """
